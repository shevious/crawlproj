...
def run_spider(settings, sighandler, keyheader=''):
    s = Settings()
    ...
    d = runner.crawl(crawler, keyheader=keyheader)
...
def ulsan_course_task(self):
    ...
    d = run_spider(settings, sighandler=sighandler, keyheader=keyheaders[keystring])
